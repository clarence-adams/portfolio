...
export default function Home() {
  ...
  const sendMessage = async () => {
    ...
    fetch('/api/send-message', options)
      .then((res) => res.json())
      .then((res) => {
        res.message !== 'success'
  ...
  return (
    <div id='app' className='App'>
      <header>
        <nav id='navbar'>
          <a className='navbar-button' href='#welcome-section'>
            About
          </a>
          <a className='navbar-button' href='#project-tiles'>
            Projects
          </a>
      ...
      <main>
        <div id='welcome-section'>
          ...
          <h1 id='page-title'>
            Hi, I&apos;m <span className='blue'>Clarence</span>
          </h1>
...
const Tile = (props) => {
  ...
  useEffect(() => {
    fetch('/api/take-screenshot/', options)
      .then((res) => res.json())
      .then((res) => {
        if (!res.buffer) {
